...
(function() {
    ...
    s.async = true;
    s.src = 'https://g.csdnimg.cn/??notification/1.3.7/notify.js,notification/1.3.7/main.js,asdf/1.0.6/trackad.js,iconfont/nav/iconfont-1.0.0.js';
...
!(function ($) {
    ...
    var setCookie = function (name, value) {
        ...
        document.cookie = name + "=" + escape(value) + ";expires=" + exp.toGMTString()+";domain=csdn.net";   // + ";domain=.csdn.net;path=/";
    }
    ...
    */
    ...
    var start_time = 1568304000, // toolbar 特殊样式起始时间戳new Date(2018,11,29).getTime()/1000
        ...
        logo_tpl = '<img src="//csdnimg.cn/cdn/content-toolbar/csdnlogo.png" class="csdn-logo">',  // 正常样式
            ...
            <ul class="btns">\
              <li>\
                <div class="search_bar" data-report-click=\'{"mod":"popu_369","pid":"toolbar","dest":"https://so.csdn.net/so/"}\' data-report-view=\'{"mod":"popu_369","pid":"toolbar","dest":"https://so.csdn.net/so/"}\'>\
                  <input type="text" class="input_search" name="" value='+ searchWord + ' id="toolber-keyword" placeholder=' + input_placeholder + '>\
                  <a href="//so.csdn.net/so/" target="_blank" class="btn-nobg-noborder btn-search">\
                  <img src="//csdnimg.cn/cdn/content-toolbar/csdn-search.png">\
                  </a>\
                </div>\
              </li>\
              ...
              <img src="//csdnimg.cn/cdn/content-toolbar/csdn-xie.png">\
              <span>写博客</span></a>\
              ...
              <li class="userinfo"><a href="https://passport.csdn.net/account/login" target="_blank">登录</a><span></span><a href="https://passport.csdn.net/account/login" target="_blank">注册</a>\
              <a data-report-click=\'{"mod":"popu_800","pid":"toolbar","dest":"https://i.csdn.net/#/uc/regard"}\' data-report-view=\'{"mod":"popu_800","pid":"toolbar","dest":"https://i.csdn.net/#/uc/regard"}\'  href="https://i.csdn.net/#/uc/regard" target="_blank" class="msg-toast msgToastText-free">签到赢大礼>></a>\
              </li>\
              <li class="userLogin">\
    ...
    $(function(){
        // 签到赢大奖
        // 判断是否点击
        let isBubble = getCookie("bubble")
        if (!isBubble) {
            let msgToastTextTree = $('.msgToastText-free')
            msgToastTextTree.addClass('msg-toast--show')
            msgToastTextTree.click(function(){
                setCookie('bubble', true)
                msgToastTextTree.removeClass('msg-toast--show')
            })
        }
    })
    ...
    $(function () {
        ...
        var appHover = {
            showMore: function () {
                ...
                $(this).find('.link-title').css('color', '#C03A3A')
                $dom.stop(true, true).fadeIn(200);
            },
            hideMore: function () {
                var $dom = $(this).find('.appControl');
